...
ActiveRecord::Schema.define(version: 20150515075857) do
  ...
  add_index "oauth_access_tokens", ["oauth_application_id"], name: "fk_rails_8e6613de9d", using: :btree
  ...
  add_index "payments", ["address_id"], name: "fk_rails_5811c9a185", using: :btree
  add_index "payments", ["single_order_detail_id"], name: "fk_rails_60dcdd4687", using: :btree
  ...
  add_index "shipments", ["single_line_item_id"], name: "fk_rails_147623f96f", using: :btree
  ...
  add_index "single_order_details", ["tax_rate_id"], name: "fk_rails_cd6487ed37", using: :btree
